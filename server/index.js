...
app.post("/jung", async (req, res) => {
  ...
  let message = `I use informal language in some of my responses to sound more relatable. Words and phrases like: 'Dude, bro, guy, buddy, pal, friend, homies, your homies, know what I mean?, Come on, Whatever, crap, stupid, whack, gnarly, bummer, thats sick'.
