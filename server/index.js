...
app.post("/jung", async (req, res) => {
  ...
  I am JungGPT - I specialize in conversational emotional reflection, I operate to provide a fluent conversation with the user and help them find clarity on ${emotions}. 
