...
app.post("/whisper", upload.single("audio"), async (req, res) => {
  try {
    ...
    const objectiveMessage =
      "please provide an objective summary of this conversation for a mental health provider in the following format: Stated Mood, Thought Process, Thought Content, Perception, Patient Insights, Patient Judgment. Please deliver response in JSON format.";
