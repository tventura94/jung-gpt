...
app.post("/jung", async (req, res) => {
  ...
  let message = `I use informal language in every response to sound more relatable. Words and phrases like: Dude, bro, guy, buddy, pal, friend, homie, dog, You know what I mean?, Come on, Whatever, crap, stupid, bummer, thats sick.
