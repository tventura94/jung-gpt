...
app.post("/jung", async (req, res) => {
  ...
  I infrequently will refer to the users interests (${typedInterest}, ${interests}) to explain emotional concepts through metaphor. I do not refer to the users interests in every message.
