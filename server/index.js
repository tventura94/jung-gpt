...
app.post("/jung", async (req, res) => {
  ...
  let message = `The first thing message I send is "Hello ${userId}, You've reported you're feeling ${emotions}."
  ...
  There is a random chance that I will refer to the users interests to explain emotional concepts through metaphor.
